  ...
  return (
    <div className="w-full max-w-container mx-auto lg:grid lg:grid-cols-[1fr_auto] lg:gap-8 lg:items-start pl-8 pr-4 mt-5">
      ...
      <Card className="bg-white shadow-lg rounded-lg w-full mb-8">
        <CardContent className="p-6 sm:p-8">
          <p className="text-sm md:text-base text-gray-700 mb-6">
            It only takes a few minutes to get a Buddy Pet Insurance quote. Simply complete this form to get a quote and
            apply online. We ask for your phone number so we can call you to answer any questions you may have and help
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  If you can't find your pet's dominant breed or cross-breed, please enter small, medium or large breed
                  based on expected size when fully grown. We factor in each breed's typical claim history to provide a
                  quote. There are some breeds that are not legally available in Australia, and we don't insure. Please
                  call us to discuss if you're unsure.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  To qualify for any Buddy Pet Insurance policies, your pet needs to be younger than 9 years of age when
              ...
              <div className="space-y-6 pt-6 border-t">
                ...
                <p className="text-gray-600">We just need some basic details to provide you with an accurate quote.</p>
                ...
                <div>
                  ...
                  >
                    <SelectTrigger className={cn("mt-2", errors.state && "border-red-500 focus-visible:ring-red-500")}>
              ...
              <p className="text-xs text-gray-500 pt-4">
                By submitting this form you consent to receiving a phone call from us for the purpose of discussing and
                providing assistance with your insurance quote. You can opt out of receiving calls from us when we
                contact you or by contacting us on <span className="font-bold">1300 678 489</span>. You acknowledge that
                you have had an opportunity to review and consider the relevant{" "}
      ...
      <div className="hidden lg:block w-full max-w-[424px]">
        <div className="sticky top-45 z-50">
