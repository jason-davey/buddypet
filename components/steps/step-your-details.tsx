...
export function StepYourDetails() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-buddy-bg-light relative">
      ...
      <div className="block lg:hidden mx-4 mt-4 mb-6">
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 mb-2 text-base">You're almost there!</h3>
      ...
      {/* Desktop callout card - positioned to the right */}
      <div className="hidden lg:block absolute top-32 right-8 w-[320px] z-30">
